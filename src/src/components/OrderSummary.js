                                    ...
                                    <div className="col-sm-8">
                                        ...
                                        <div className=" quantite_value">
                                            <div ><br />Quantité :
                                                ...
                                                <input data-id="prod1" id="quantite" type="number" min="1" value={order.quatity} className="quantite__input" />
                        ...
                        <div className="col-sm-3 py-5">
                            <div className=" border" style={{display: 'block'}}>
                                ...
                                <div className=" d-flex mt-2 total py-5">
                                    ...
                                    <span className="font-baloo font-size-16 mt-1 mr-5" id="price"><strong>.00 Dhs</strong></span>
                                </div>
                                <div className=" d-flex  total py-5">
